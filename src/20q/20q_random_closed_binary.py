...
class TwentyQuestions:
    ...
    def get_next_query(self, history):
        ...
        entropy_estimates = np.random.rand(len(sampled_queries)) #TODO
    ...
    def run_one_sample(self, label):
        ...
        for k in range(self.n_iterations):
            ...
            # predict
            posterior_k, predict_k = self.compute_posteriors([history], max_new_tokens=500)
...
def main(args):
    ...
    # save dir 
    save_path = f"{args.save_dir}/n_iterations{args.n_iterations}-seed{args.seed}/"
